...
+   '<p class="dlg-sub">The award-winning AI-driven software, started and proven with the NHS, now scaling to regulated organisations worldwide.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "The award-winning AI-driven software, started and proven with the NHS, now scaling to regulated organisations worldwide.";
