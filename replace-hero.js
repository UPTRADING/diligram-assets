...
+   '<p class="dlg-sub">Built for the day the regulator walks in unannounced \u2014 and you welcome them.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "Built for the day the regulator walks in unannounced \u2014 and you welcome them.";
