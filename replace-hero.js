...
+   '<p class="dlg-sub">The award-winning AI-driven execution layer for regulated organisations \u2014 putting leaders in control of what every frontline receives, engages with, and completes, in real time.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "The award-winning AI-driven execution layer for regulated organisations \u2014 putting leaders in control of what every frontline receives, engages with, and completes, in real time.";
