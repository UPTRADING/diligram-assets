...
+   '<p class="dlg-sub">The award-winning AI operating system for regulated organisations. One defensible chain of control \u2014 from policy to proof.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "The award-winning AI operating system for regulated organisations. One defensible chain of control \u2014 from policy to proof.";
