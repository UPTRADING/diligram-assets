...
+   '<p class="dlg-sub">Finally, you\u2019ll welcome the day the regulator walks in unannounced.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "Finally, you\u2019ll welcome the day the regulator walks in unannounced.";
