...
+   '<p class="dlg-sub">The award-winning AI-driven software that puts leaders in control of what every frontline receives, engages with, and completes, in real time.</p>'
...
export default async (request, context) => {
  ...
  const OG_DESC  = "The award-winning AI-driven software that puts leaders in control of what every frontline receives, engages with, and completes, in real time.";
