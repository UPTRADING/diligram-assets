...
+   '<p class="dlg-sub">AI-driven, human-approved, effortless end to end: every policy, procedure and instruction \u2014 authored, signed off, delivered, executed, attested, evidenced \u2014 automatically, in real time, 100% auditable and compliant.</p>'
...
+     '<div><span class="dlg-stat-big">76\u219298%</span><span class="dlg-stat-label">Documented compliance improvement in 6 months</span></div>'
...
function fixButtonCaps(){
  document.querySelectorAll('a[href*="mystaffapp.ai/contact"][class*="bg-primary"]').forEach(function(a){
    var t=a.firstChild; if(t&&t.nodeType===3) t.textContent=t.textContent.replace('Get in touch','Get in Touch');
  });
  document.querySelectorAll('a[class*="bg-primary"][class*="gap-3"]').forEach(function(a){
    var t=a.firstChild; if(t&&t.nodeType===3) t.textContent=t.textContent.replace('Check more','Check More');
  });
}
...
export default async (request, context) => {
  ...
  const OG_DESC  = "AI-driven, human-approved, effortless end to end: every policy, procedure and instruction \u2014 authored, signed off, delivered, executed, attested, evidenced \u2014 automatically, in real time, 100% auditable and compliant.";
